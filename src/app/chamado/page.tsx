            ...
            {isSignUp ? (
                <div style={{ width: '350px', padding: '40px', background: 'white', borderRadius: '10px', boxShadow: '0 4px 10px rgba(0, 0, 0, 0.1)', color: 'black' }}>
                    ...
                    <form id="registrationForm" onSubmit={handleSubmit}>
                        <div style={{ marginBottom: '20px' }}>
                            ...
                            <input type="text" id="username" name="username" required style={{ width: 'calc(100% - 20px)', padding: '10px', fontSize: '16px', border: '1px solid #ccc', borderRadius: '5px' }} />
                        </div>
                        <div style={{ marginBottom: '20px' }}>
                            <label htmlFor="email" style={{ display: 'block', fontWeight: 'bold', marginBottom: '5px' }}>Endereço de email</label>
                            <input type="email" id="email" name="email" required style={{ width: 'calc(100% - 20px)', padding: '10px', fontSize: '16px', border: '1px solid #ccc', borderRadius: '5px' }} />
                        </div>
                        <div style={{ marginBottom: '20px' }}>
                            <label htmlFor="password" style={{ display: 'block', fontWeight: 'bold', marginBottom: '5px' }}>Senha</label>
                            <input type="password" id="password" name="password" required style={{ width: 'calc(100% - 20px)', padding: '10px', fontSize: '16px', border: '1px solid #ccc', borderRadius: '5px' }} />
                        </div>
                        <div style={{ marginBottom: '20px' }}>
                            <input type="checkbox" name="recaptcha" required /> Não sou um robô
                        </div>
                        <div style={{ marginBottom: '20px' }}>
                            <input type="submit" value="Criar uma conta" style={{ width: '100%', backgroundColor: 'black', color: 'white', fontWeight: 'bold', border: 'none', cursor: 'pointer', padding: '15px', borderRadius: '5px' }} />
                        </div>
                        <div style={{ marginBottom: '20px' }}>
                ...
                <div style={{ width: '350px', padding: '40px', background: 'white', borderRadius: '10px', boxShadow: '0 4px 10px rgba(0, 0, 0, 0.1)', color: 'black' }}>
                    ...
                    <form id="loginForm" onSubmit={handleSubmit}>
                        ...
                        <div style={{ marginBottom: '20px' }}>
                            <input type="submit" value="Entrar" style={{ width: '100%', backgroundColor: 'black', color: 'white', fontWeight: 'bold', border: 'none', cursor: 'pointer', padding: '15px', borderRadius: '5px' }} />
                        </div>
                    </form>
